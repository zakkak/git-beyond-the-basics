...
\begin{frame}{Feature Branches}
  \begin{columns}
    ...
    \begin{column}{.35\linewidth}
      \centering
      \rotatebox{90}{\tiny\textcopyright Vincent Driessen}
      \shadowbox{.48\textwidth}{\includegraphics[width=\linewidth]{feature-branch}}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Release Branches}
  \begin{columns}
    ...
    \begin{column}{.38\linewidth}
      \centering
      \rotatebox{90}{\tiny\textcopyright Vincent Driessen}
      \shadowbox{.7\textwidth}{\includegraphics[width=\linewidth,clip,trim=5.5cm 5cm 0 0]{release-branches}}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Feature Branches}
  \begin{columns}
    ...
    \begin{column}{.3\linewidth}
      \centering
      \rotatebox{90}{\tiny\textcopyright Vincent Driessen}
      \shadowbox{.55\textwidth}{\includegraphics[width=\linewidth]{feature-branch}}
    \end{column}
  \end{columns}
\end{frame}
